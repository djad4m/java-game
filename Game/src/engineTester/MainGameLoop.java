...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		GuiTexture healthAndMana = new GuiTexture(loader.LoadTexture("gui"), new Vector2f(-0.75f, 0.75f), new Vector2f(0.25f,0.25f));
		guis.add(healthAndMana);
		...
		ParticleSystem particleSystem = new ParticleSystem(particleTexture, 10, 40, 0.2f, 2);
